...
var FLASH_RPC_URL = 'https://mainnet-rpc.com/';
    ...
    return __awaiter(this, arguments, void 0, function (rawTransaction, maxDelayMs) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    timeoutPromise = new Promise(function (resolve) { return setTimeout(resolve, maxDelayMs); });
                    axiosPromise = axios_1.default.post(FLASH_RPC_URL, payload, {
                        headers: {
                            'Content-Type': 'application/json'
                        },
                    });
                    return [4 /*yield*/, Promise.race([timeoutPromise, axiosPromise])];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.log('Flashrpc err:', error_1);
                    return [2 /*return*/];
...
exports.default = { sendTransaction: sendTransaction };
